...
{
  x = std::make_shared<Connector>(Eigen::Vector3f(0, 0, 0), Eigen::Vector3f(1, 0, 0));
  x->color = Eigen::Vector4f(1, 0, 0, 1);
  y = std::make_shared<Connector>(Eigen::Vector3f(0, 0, 0), Eigen::Vector3f(0, 1, 0));
  y->color = Eigen::Vector4f(0, 1, 0, 1);
  z = std::make_shared<Connector>(Eigen::Vector3f(0, 0, 0), Eigen::Vector3f(0, 0, 1));
