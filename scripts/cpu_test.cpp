...
namespace FeatureDetector{
	...
	void cpu_x86::printFeatures() const{
		if (Vendor_AMD) cout << "AMD;";
		if (Vendor_Intel) cout << "Intel;";

#ifdef _WIN32
		if (OS_x64) cout << "OS_x64;";		
#endif
		if (OS_AVX) cout << "OS_AVX;";
		if (OS_AVX512) cout << "OS_AVX512;";

		if (HW_MMX) cout << "MMX;";
		if (HW_x64) cout << "x64;";
		if (HW_ABM) cout << "ABM;";
		if (HW_RDRAND) cout << "RDRAND;";
		if (HW_BMI1) cout << "BMI1;";
		if (HW_BMI2) cout << "BMI2;";
		if (HW_ADX) cout << "ADX;";
		if (HW_MPX) cout << "MPX;";
		if (HW_PREFETCHWT1) cout << "PREFETCHWT1;";

		if (HW_SSE) cout << "SSE;";
		if (HW_SSE2) cout << "SSE2;";
		if (HW_SSE3) cout << "SSE3;";
		if (HW_SSSE3) cout << "SSSE3;";
		if (HW_SSE4a) cout << "SSE4a;";
		if (HW_SSE41) cout << "SSE4.1;";
		if (HW_SSE42) cout << "SSE4.2;";
		if (HW_AES) cout << "AES-NI;";
		if (HW_SHA) cout << "SHA;";

		if (HW_AVX) cout << "AVX;";
		if (HW_XOP) cout << "XOP;";
		if (HW_FMA3) cout << "FMA3;";
		if (HW_FMA4) cout << "FMA4;";
		if (HW_AVX2) cout << "AVX2;";

		if (HW_AVX512_F) cout << "AVX512-F;";
		if (HW_AVX512_CD) cout << "AVX512-CD;";
		if (HW_AVX512_PF) cout << "AVX512-PF;";
		if (HW_AVX512_ER) cout << "AVX512-ER;";
		if (HW_AVX512_VL) cout << "AVX512-VL;";
		if (HW_AVX512_BW) cout << "AVX512-BW;";
		if (HW_AVX512_DQ) cout << "AVX512-DQ;";
		if (HW_AVX512_IFMA) cout << "AVX512-IFMA;";
		if (HW_AVX512_VBMI) cout << "AVX512-VBMI;";
		


		if (HW_AVX && OS_AVX) cout << "USE_AVX;";
		if (HW_AVX512_F && OS_AVX512) cout << "USE_AVX512;";
		cout << endl;
	}
